...
#' 
#' @name ctlcurves2
#' @aliases print.ctlcurves2
#' @description The function applies \code{\link{tclust2}} several times on a given dataset while parameters 
...
#'
#'    ##  the selected model 
#'  plot(tclust2(x, k = 2, alpha = 0.08, restr.fact = 7))
#'
#'  #--- EXAMPLE 2 ------------------------------------------
#'
#'  data(geyser2)
...
#'
#'    ##  the selected model
#'  plot(tclust2(geyser2, k = 3, alpha = 0.08, restr.fact = 5))
#'
#'
#'  #--- EXAMPLE 3 ------------------------------------------
#'  
